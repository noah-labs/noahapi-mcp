...
export const postCheckoutPayoutFiatSchema = z.object({
  ...
  LineItems: z
    ...
    .describe(
      "List of line items that your customer is getting paid for using this Hosted Checkout Session. This is used for display purposes for the customer during Checkout as well as remediation of disputed payments.",
    ),
  Nonce: z.string(),
});
